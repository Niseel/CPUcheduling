...
public class DrawGrantt extends JFrame {
   ...
   public DrawGrantt(String titleScheduling, Entity.Process[] arrProcesses, int quantime) {
    ...
    private static IntervalCategoryDataset createDataset(String title, Entity.Process[] arrProcesses, int quantime) {
    ...
    public static JPanel createDemoPanel(String title, Entity.Process[] arrProcesses, int quantime) {
